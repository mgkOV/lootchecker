...
describe('Wallet', () => {
  ...
  it('creates an input to deposit into or with draw from the balance', () => {
  ...
  describe('when the user types into the wallet input', () => {
    ...
    describe('and the user wants to make a deposit', () => {
      ...
      it('cleans the wallet input', () => {
        expect(wallet.find('.input-wallet').props().value).toEqual('');
        expect(wallet.state().balance).toEqual('');
      });
    });

    describe('and the user wants to make withdrawal', () => {
